...
- **SIGUIENTE PASO (EN CURSO Sesion-007):** **Bloque F** — WF-01 `.archon/workflows/smc-sprint.yaml` + SCR-01 `launch-tv-agent.ps1` + SCR-03 `check-core-sync.ps1` [NUEVO] + SCR-04 `process-video.ps1` [opcional, no bloquea]. SCR-02 ✅ ya hecho. Tras Bloque F → VER-01..08 → **gate VER-09 REVISIÓN-FABLE**.
