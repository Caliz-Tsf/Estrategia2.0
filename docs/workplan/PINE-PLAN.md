...
13b. **Mapa MTF rico** — `N_htf` zonas/lado (OB/FVG/pool/sweep) en tuple plano capado (presupuesto ~127, `ESQUELETO-P3 §2.2`) + `f_nearestN` pura en CORE + reconstitución y dibujo en cascada con cuota de objetos. ✅ **COMPLETO (S041)** — entrega un **mapa de niveles** (líneas extendidas al borde).
