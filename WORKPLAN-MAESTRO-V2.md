...
- [ ] **F1-GATE** Validación integral: **los conceptos de detección T01–T40** (Tier 1-2 + gap ICT Ruta A/D) ≥90 · panel OK · anti-repaint test (2 días paper visual) · performance 20k barras · re-evaluar presupuesto de objetos de dibujo (+~12 conceptos, `PINE-PLAN §5`) · tag git `fase-1-completa`.
