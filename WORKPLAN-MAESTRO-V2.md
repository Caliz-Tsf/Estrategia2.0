...
- [ ] **F1-S1.3** Liquidez: **[x] T09 pools (Sesion-027, commit 139e1c1, compile 0/0, core sync OK 503 líneas SHA 2949a93, f_buildPools clustering EQH/EQL+swings, visual BSL/SSL dashed naranja/aqua, bug fix FIFO→push, decision mitigación+swept diferido Opus Max, validación ≥90 pendiente).** · T10 sweeps+grabs · T11 Kill Zones (convención DST de P-25) · T12 MSS — **done T12 incluye acumular ≥3 MSS swing reales** vía scroll/replay histórico `[VER-09 D1]`.
