...
- [ ] **F1-S1.6 Fase 1 (codificación)** — T26–T40 siguiendo pipeline 7 etapas (spec cuantificada ✅ Sesion-047 → `f_detect*` puro → 0/0 + core-sync → validación ≥90 → confluencia §4.8 → golden test MQL5 → commit). Próxima sesión tras validación Tier 2.
