...
- [ ] **F1-S1.1** Fundación: **[x] T01 esqueleto 3 archivos + UDTs + arrays acotados (Sesion-011, commit 45449f3, compile 0/0, core sync OK)** · [ ] T02 swings+clasificación (migración v5→v6 del LuxAlgo) · [ ] T03 BOS+CHoCH · [ ] T04 bias por TF. Done: validados ≥90 + commit cada uno (+ paridad ver05 en T02/T03).
